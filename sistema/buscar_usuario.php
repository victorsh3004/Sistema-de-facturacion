	...
	<section id="container">
		...
		<table>
			...
			//Paginador
				...
				$sql_register=mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM 								usuario WHERE (idusuario LIKE '%$busqueda%' OR 
				...
				$query = mysqli_query($conection, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol 
												...
												(u.idusuario LIKE '%$busqueda%' OR 	
													...
													u.estatus = 1 ORDER BY u.idusuario ASC LIMIT $desde,$por_pagina");
