...
<body>
		...
		<table class="tbl_venta">
			<thead>
				...
				<tr>
					...
					<td id="txt_precio" class="texttright">0.00</td>
	...
	<script type="text/javascript">
		$(document).ready(function(){ //Funcion que se ejecuta despues de haber cargado todo el html
...
<!-- Sistema de Ventas y Facturación (Agregar productos al detalle Parte 1) - 56
https://www.youtube.com/watch?v=w84nFG7GZh8&list=PL3b9xmg86NTLHvul_VxsDda31xH6u8OdI&index=45
